...
export function Footer({locale}:{locale:Locale}) { const t=getDictionary(locale); return <footer className="site-footer">
  ...
  <div className="footer-links"><Link href={`/${locale}/about`}>{t.about}</Link><Link href={`/${locale}/services`}>{t.services}</Link><Link href={`/${locale}/packages`}>{t.packages}</Link><Link href={`/${locale}/news`}>{t.news}</Link><Link href={`/${locale}/gallery`}>{t.gallery}</Link><Link href={`/${locale}/events`}>{t.events}</Link><Link href={`/${locale}/contact`}>{t.contact}</Link><Link href={`/${locale}/privacy`}>{t.privacy}</Link><Link href={`/${locale}/terms`}>{t.terms}</Link></div>
