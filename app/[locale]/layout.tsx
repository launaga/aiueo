...
export const metadata: Metadata = { metadataBase:new URL(process.env.NEXT_PUBLIC_SITE_URL||'https://aiueo.mglwebkits.com'), title:{default:'AIUEO Event Organizer',template:'%s | AIUEO'}, description:'AIUEO corporate event organizer in Jakarta, Indonesia.' };
